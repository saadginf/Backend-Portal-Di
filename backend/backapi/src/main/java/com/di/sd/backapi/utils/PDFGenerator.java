  ...
  public static ByteArrayInputStream customerPDFReport(List<Inventaire> inventaire, Unite unite, Theme theme)
    ...
    try {
      ...
      BaseFont bf = BaseFont.createFont(
          "/Users/saadevops/Documents/Dev/PortalWeb/portal-web-di/backend/backapi/src/main/java/com/di/sd/backapi/utils/arabicFont.ttf",
      ...
      Paragraph para = new Paragraph(
          "CATALOGUE INVENTAIRE DES VOLUMES\nModèle 01/DOC/FAR\nDésignation du thèmr des documents: "
              + theme.getLibbele(),
          font);
      para.setLeading(15);
      ...
      for (Inventaire inv : inventaire) {
        System.out.println(inv.getTitre());
        PdfPCell idCell = new PdfPCell(new Phrase(inv.getNumber(), font3));
        ...
        PdfPCell dateAc = new PdfPCell(new Phrase("" + inv.getDate_ac().split("-")[0], font3));
        ...
        PdfPCell autCell = new PdfPCell(new Phrase(inv.getAuteurs(), font3));
        autCell.setRunDirection(PdfWriter.RUN_DIRECTION_RTL);
        ...
        PdfPCell titreCell = new PdfPCell(new Phrase(inv.getTitre(), font3));
        titreCell.setRunDirection(PdfWriter.RUN_DIRECTION_RTL);
        ...
        PdfPCell editeurCell = new PdfPCell(new Phrase(inv.getEditeur(), font3));
        ...
        PdfPCell pubCell = new PdfPCell(new Phrase("" + inv.getDate_pub(), font3));
        ...
        if (inv.getTomes().size() == 1) {
          PdfPCell tomcCell = new PdfPCell(new Phrase("-", font3));
          ...
          PdfPCell qteCell = new PdfPCell(new Phrase(inv.getQte().get(0).toString(), font3));
          ...
          PdfPCell obsCell = new PdfPCell(new Phrase("-", font3));
          ...
          for (int i = 0; i < inv.getTomes().size(); i++) {
            PdfPCell obsCell = new PdfPCell(new Phrase(inv.getTomes().get(i), font3));
            obsCell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            obsCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            obsCell.setPaddingRight(4);
            table.addCell(obsCell);
            PdfPCell qteCell = new PdfPCell(new Phrase(inv.getQte().get(i).toString(), font3));
            qteCell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            qteCell.setHorizontalAlignment(Element.ALIGN_CENTER);
            qteCell.setPaddingRight(4);
            table.addCell(qteCell);
            PdfPCell obsfCell = new PdfPCell(new Phrase("-", font3));
